...
GMDIR="/opt/geomesa-hbase_2.11-3.1.0"
...
echo "Bootstrapping GeoMesa HBase with version 3.1.0 installed at ${GMDIR}"
...
DISTRIBUTED_JAR_NAME=geomesa-hbase-distributed-runtime-hbase1_2.11-3.1.0.jar
